...
/** Global variable for a 4 byte workaround
    ...
    processing function **/
static gboolean gst_goo_dech264_720p_parsed_header = FALSE;
...
static const GstElementDetails details =
        GST_ELEMENT_DETAILS (
                "OpenMAX H264 ittiam decoder",
                "Codedc/Decoder/Video",
                "Decodes H264 720p streams with OpenMAX",
                "Texas Instrument"
                );
...
static void
gst_goo_dech264_720p_base_init (gpointer g_klass)
{
        GST_DEBUG_CATEGORY_INIT (gst_goo_dech264_720p_debug, "goodech264720p", 0,
                                 "OpenMAX H264 720p decoder element");
...
static GstBuffer*
gst_goo_dech264_720p_codec_data_processing (GstGooVideoFilter *filter, GstBuffer *buf)
{
	...
	if (GST_IS_BUFFER (GST_GOO_VIDEODEC720P(self)->video_header))
	{
		...
		gst_goo_dech264_720p_parsed_header = TRUE;
		...
		{
			case 1:
				g_object_set (G_OBJECT (component), "NALU-byte-type", GOO_TI_H264DEC720P_NALU_BYTES_TYPE_1B, NULL);
				Header_size=1;
				break;
			case 2:
				g_object_set (G_OBJECT (component), "NALU-byte-type", GOO_TI_H264DEC720P_NALU_BYTES_TYPE_2B, NULL);
				Header_size=2;
				break;
			case 4:
				...
				break;
			default:
				g_object_set (G_OBJECT (component), "NALU-byte-type", GOO_TI_H264DEC720P_NALU_BYTES_TYPE_0B, NULL);
				Header_size=4;
				break;
		}
...
static GooTiH264720pNALUBytesType
gst_goo_dech264_720p_get_NALU_byte_type (GstGooDecH264720p* self)
{
    GooTiH264720pNALUBytesType NALU_bytes_type;
	GooComponent *component = GST_GOO_VIDEO_FILTER (self)->component;
...
static GstBuffer*
gst_goo_dech264_720p_extra_buffer_processing (GstGooVideoFilter* filter, GstBuffer *buffer)
{
	...
	gboolean is_Bitstream_mode = gst_goo_dech264_720p_get_NALU_byte_type(self) == GOO_TI_H264DEC720P_NALU_BYTES_TYPE_0B;
	...
	if (!NALU_size_bytes)
	{
		switch (gst_goo_dech264_720p_get_NALU_byte_type(self))
		{
			case GOO_TI_H264DEC720P_NALU_BYTES_TYPE_1B:
				Header_size=1;
				NALU_size_bytes=1;
				break;
			case GOO_TI_H264DEC720P_NALU_BYTES_TYPE_2B:
				Header_size=2;
				NALU_size_bytes=2;
				break;
			case GOO_TI_H264DEC720P_NALU_BYTES_TYPE_4B:
				Header_size=4;
				NALU_size_bytes=4;
				break;
			default:
	...
	if ( gst_goo_dech264_720p_parsed_header == TRUE && !first_buffer && is_Bitstream_mode)
	{
...
static void
gst_goo_dech264_720p_class_init (GstGooDecH264720pClass* klass)
{
	...
	gst_c_klass->codec_data_processing_func = GST_DEBUG_FUNCPTR (gst_goo_dech264_720p_codec_data_processing);
	gst_c_klass->extra_buffer_processing_func = GST_DEBUG_FUNCPTR (gst_goo_dech264_720p_extra_buffer_processing);

	return;
}

static void
gst_goo_dech264_720p_init (GstGooDecH264720p* self, GstGooDecH264720pClass* klass)
{
	GST_DEBUG ("");

	GST_GOO_VIDEO_FILTER (self)->component = goo_component_factory_get_component
		(GST_GOO_VIDEO_FILTER (self)->factory, GOO_TI_H264_720P_DECODER);

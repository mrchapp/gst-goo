...
static gboolean
gst_goo_decgsmfr_process_mode_default (GstGooAudioFilter *self, guint value)
{
...
gst_goo_decgsmfr_class_init (GstGooDecGsmFrClass *klass)
{
    ...
    gst_c_klass->set_process_mode_func = GST_DEBUG_FUNCPTR (gst_goo_decgsmfr_process_mode_default);
